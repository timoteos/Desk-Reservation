...
export default function ReservationPage() {
  ...
  const handleSeeAvailability = () => {
    ...
    navigate(`/calendar?startDate=${startDate}`);
  };
        ...
        <div className="w-full max-w-lg flex flex-col gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-800 text-xl font-semibold w-6 text-center">{days}</span>
              <button
          ...
          {/* No earlier than */}
          <div>
            <p className="text-gray-700 font-medium mb-2">No earlier than <span className="text-gray-400 font-normal">(optional)</span></p>
